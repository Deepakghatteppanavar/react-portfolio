  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
        <img className="logoimg" src="./img/logo1.png" alt="Logoipsum"  />
        </div>
        <div className="footer--items">
          <ul>
          <li>
            <Link
              activeClass="navbar--active-content" spy={true} smooth={true} offset={-70} duration={500}
              to="heroSection"
          ...
          <li>
            <Link
              ...
              duration={500}
              to="AboutMe"
              className="navbar--content">Experiance</Link>
          </li>

          <li>
            <Link
              activeClass="navbar--active-content" spy={true} smooth={true}
              offset={-70} duration={500}
              to="skills--section"
              className="navbar--content">Skills</Link></li>
          ...
          <li>
            <Link
              ...
              duration={500}
              to="Certificate"
              className="navbar--content">Certificate</Link>
          </li>
